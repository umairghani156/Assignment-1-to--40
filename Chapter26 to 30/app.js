// Question No 1
//  let positiveInteger = Number(prompt("Enter an integer number"));
// Or we can simply declare a variable instead of prompt
/*
...
document.write(`Number: ${positiveInteger} <br>round off value: ${conIntoRound} <br>floor value: ${conIntoRound2} <br>Ceil value: ${conIntoRound3}`);
...
document.write(`<br><br>Number: ${negativePoint} <br>round off value: ${negIntoRound} <br>floor value: ${negIntofloor} <br>Ceil value: ${negIntoCeil}`);
